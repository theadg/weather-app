...
var showWeather = function showWeather() {
  if (weatherResult.classList.contains('hidden')) weatherResult.classList.remove('hidden');
};
var hideWeather = function hideWeather() {
...
weatherLocation.onkeypress = function (e) {
  if (e.key === 'Enter') {
    getWeather(weatherLocation.value);
  }
};
